...
import com.business.portfolio.breaking.presentation.ui.detail.Extra
...
class DetailExtraComponentTest {
    ...
    fun setUp() {
        composeTestRule.setContent {
            Extra(
                character = character1.toCharacter()
            )
        }
    }
    ...
    @Test
    fun component_show_seasons() {
        composeTestRule.onNodeWithText("Seasons: 1,4,5").assertExists()
    }
